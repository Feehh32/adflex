  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ApiService, [{
    ...
    value: function () {
      var _getWithId = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2(endpoint, id) {
        var parseId, url, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              parseId = parseInt(id, 10);
              url = "".concat(this.baseUrl, "/").concat(endpoint, "/").concat(parseId);
              _context2.next = 5;
              return fetch(url);
            case 5:
    ...
    key: "getBalance",
    value: function () {
      var _getBalance = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee3(endpoint, date) {
        var encodeDate, url, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              encodeDate = encodeURIComponent(date);
              url = "".concat(this.baseUrl, "/").concat(endpoint, "/").concat(encodeDate);
              _context3.next = 5;
              return fetch(url);
            case 5:
    ...
    value: function () {
      ...
      function getMonthSales(_x6, _x7, _x8) {
    ...
    value: function () {
      ...
      function createServiceNote(_x12) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return apiService.getMonthSales("os", date, id);
            case 7:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return apiService.getBalance("os", monthYear);
            case 6:
              _yield$apiService$get = _context.sent;
              os = _yield$apiService$get.os;
