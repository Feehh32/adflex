...
/* harmony import */ var _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/api_service.js */ "./js/modules/helpers/api_service.js");
...
var ClientOs = /*#__PURE__*/function () {
  function ClientOs(osWrapper, osSearch, btnShowMore, btnShowLess, client, url) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, ClientOs);
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ClientOs, [{
    key: "filterOsPerCLient",
    value: function () {
      var _filterOsPerCLient = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee() {
        var apiServices, _yield$apiServices$ge, os;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              apiServices = new _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_5__["default"](this.url);
              _context.next = 4;
              return apiServices.getParameters("os/by-id", parseInt(this.client.id, 10));
            case 4:
              _yield$apiServices$ge = _context.sent;
              os = _yield$apiServices$ge.os;
      ...
      function filterOsPerCLient() {
        return _filterOsPerCLient.apply(this, arguments);
      }
      return filterOsPerCLient;
    }() //  Métodos de exibição
    // Mostras as notas de serviço na tela em ordem de inserção
  }, {
    key: "showOsOnPage",
    value: function showOsOnPage() {
      var _this = this;
      var revFilteredOs = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this.filteredOs).reverse().slice(0, this.osBoxSize);
      this.osWrapper.innerHTML = "";
      revFilteredOs.forEach(function (os) {
        var customDate = (0,_helpers_formatDate_js__WEBPACK_IMPORTED_MODULE_6__.handleCustomDate)(os.date);
        ...
        li.innerHTML = htmlOs;
        _this.osWrapper.appendChild(li);
      });
    }
    ...
    key: "loadOsData",
    value: function () {
      var _loadOsData = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee2() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.filterOsPerCLient();
            case 2:
              this.filteredOs = _context2.sent;
              this.showOsOnPage();
      ...
      function loadOsData() {
        return _loadOsData.apply(this, arguments);
      }
      return loadOsData;
    }() // Métodos de execução
    ...
    key: "init",
    value: function () {
      var _init = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee3() {
...
var FormOs = /*#__PURE__*/function () {
  function FormOs(form, btnServAmount, services, clients, url) {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(FormOs, [{
    ...
    key: "findLastOs",
    value: // Método que encontra a última os adicionada
    function () {
      var _findLastOs = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee(clientName) {
        var apiService, _yield$apiService$get, os;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              apiService = new _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_6__["default"](this.url);
              _context.next = 3;
              return apiService.getParameters("os/by-clientName", clientName);
            case 3:
      ...
      function findLastOs(_x) {
        return _findLastOs.apply(this, arguments);
      }
      return findLastOs;
    }() // Método que compara as datas da os a ser inserida com a última os retornada
  }, {
    key: "getOsCode",
    value: // Método que cria o codigo de controle da os
    function () {
      var _getOsCode = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee2(date, clientName) {
        var lastOs;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.findLastOs(clientName);
            case 2:
              lastOs = _context2.sent;
              if (!(lastOs !== null && date && FormOs.comparingDate(date, lastOs.date))) {
                _context2.next = 5;
                break;
              }
              return _context2.abrupt("return", String(Number(lastOs.code) + 1).padStart(3, 0));
            case 5:
              return _context2.abrupt("return", "1".padStart(3, 0));
            case 6:
            case "end":
              return _context2.stop();
          }
      ...
      function getOsCode(_x2, _x3) {
        return _getOsCode.apply(this, arguments);
      }
      return getOsCode;
    }() // Métodos de execução
    ...
    function () {
      var _handleRegister = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee3(e) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.t0 = clientName;
              _context3.t1 = this.getHiddenMeasure();
              _context3.t2 = e.target.elements.thickness.value;
              _context3.t3 = this.handleServiceValues(e);
              _context3.t4 = this.currentDate;
              _context3.next = 13;
              return this.getOsCode(this.currentDate, clientName);
            case 13:
              _context3.t5 = _context3.sent;
              _context3.t6 = FormOs.handleBudgetValue();
              formObj = {
                client: _context3.t0,
                hideMeasure: _context3.t1,
                thickness: _context3.t2,
                service: _context3.t3,
                date: _context3.t4,
                total: 0,
                code: _context3.t5,
                budgetValue: _context3.t6
              };
            ...
            case 20:
              _yield$apiServices$po = _context3.sent;
            ...
            case 25:
              _context3.prev = 25;
              _context3.t7 = _context3["catch"](17);
...
var ApiService = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ApiService, [{
    ...
    key: "getParameters",
    value: function () {
      var _getParameters = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2(endpoint, param) {
        var url, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              url = "".concat(this.baseUrl, "/").concat(endpoint, "/").concat(param);
              _context2.next = 4;
              return fetch(url);
            case 4:
      ...
      function getParameters(_x2, _x3) {
    ...
    key: "getBalance",
    value: function () {
      var _getBalance = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee3(endpoint, month, year) {
        var encodeMonth, encodeYear, url, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              encodeMonth = encodeURIComponent(month);
              encodeYear = encodeURIComponent(year);
              url = "".concat(this.baseUrl, "/").concat(endpoint, "/").concat(encodeMonth, "/").concat(encodeYear);
              _context3.next = 6;
              return fetch(url);
            case 6:
      ...
      function getBalance(_x4, _x5, _x6) {
    ...
    key: "getMonthSales",
    value: function () {
      var _getMonthSales = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee4(endpoint, date, id) {
        var encodeDate, parseId, url, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              encodeDate = encodeURIComponent(date);
              parseId = parseInt(id, 10);
              url = "".concat(this.baseUrl, "/").concat(endpoint, "/").concat(encodeDate, "/").concat(parseId);
              _context4.next = 6;
              return fetch(url);
            case 6:
            ...
            case 14:
              ...
              console.error("Erro ao buscar no servidor:", _context4.t0);
              throw _context4.t0;
            case 18:
            case "end":
      ...
      function getMonthSales(_x7, _x8, _x9) {
    ...
    key: "post",
    value: function () {
      var _post = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee5(endpoint, data) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 18:
              ...
              console.error("Erro ao enviar dados para o servidor:", _context5.t0);
              throw _context5.t0;
            case 22:
            case "end":
    ...
    key: "createClient",
    value: function () {
      var _createClient = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee6(data) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              return _context6.abrupt("return", this.post("clients", data));
            case 1:
            case "end":
    ...
    value: function () {
      var _createServiceNote = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee7(data) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              return _context7.abrupt("return", this.post("os", data));
            case 1:
            case "end":
      ...
      function createServiceNote(_x13) {
    ...
    key: "delete",
    value: function () {
      var _delete2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee8(endpoint) {
    ...
    key: "put",
    value: function () {
      var _put = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee9(endpoint, data) {
        var url, response;
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _helpers_event_emitter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/event_emitter.js */ "./js/modules/helpers/event_emitter.js");
/* harmony import */ var _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/api_service.js */ "./js/modules/helpers/api_service.js");
...
var ShowClientsIndex = /*#__PURE__*/function () {
  function ShowClientsIndex(clientsWrapper, clients, url) {
    var _this = this;
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ShowClientsIndex);
    ...
    _helpers_event_emitter_js__WEBPACK_IMPORTED_MODULE_4__["default"].on("clearSearch", function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ShowClientsIndex, [{
    key: "osAmountByClient",
    value: function () {
      var _osAmountByClient = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
        var apiService, _yield$apiService$get, osAmount;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              apiService = new _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_5__["default"](this.url);
              _context.next = 3;
              return apiService.get("os/amount");
            case 3:
              _yield$apiService$get = _context.sent;
              osAmount = _yield$apiService$get.osAmount;
              return _context.abrupt("return", osAmount);
            case 6:
            case "end":
              return _context.stop();
          }
      ...
      function osAmountByClient() {
        return _osAmountByClient.apply(this, arguments);
      }
      return osAmountByClient;
    }() // Método que renderiza na tela o card com as informações do cliente
  }, {
    key: "showClients",
    value: function () {
      var _showClients = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee3() {
        var _this2 = this;
        var osAmount;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return this.osAmountByClient();
            case 2:
              osAmount = _context3.sent;
              osAmount.forEach( /*#__PURE__*/function () {
                var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2(os) {
                  var clientCard;
                  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      case 0:
                        clientCard = document.createElement("a");
                        clientCard.classList.add("main__clients-card");
                        clientCard.href = "./client.html?id=".concat(os.client_id);
                        clientCard.innerHTML = "\n                              <h3 class=\"font-os-xl-b color-1\">".concat(os.client_name, "</h3>\n                              <p class=\"font-os-m color-2\">Ordens de servi\xE7o: <span class=\"font-os-m color-2 clients__card-client-number\">").concat(os.amount_os, "</span></p>\n                              ");
      ...
      function showClients() {
        return _showClients.apply(this, arguments);
      }
      return showClients;
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _helpers_monetaryMask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/monetaryMask */ "./js/modules/helpers/monetaryMask.js");
/* harmony import */ var _client_form_validations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../client/form_validations */ "./js/modules/client/form_validations.js");
/* harmony import */ var _helpers_formatDate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helpers/formatDate.js */ "./js/modules/helpers/formatDate.js");
/* harmony import */ var _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../helpers/api_service.js */ "./js/modules/helpers/api_service.js");
...
var MonthSales = /*#__PURE__*/function () {
  function MonthSales(form, salesWrapper, btnPrint, clients, url) {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(MonthSales, [{
    ...
    key: "searchOs",
    value: function () {
      var _searchOs = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
        var _JSON$parse, clientSale, monthSale, yearSale, objSales, date, _this$clients$find, id, apiService, _yield$apiService$get, os;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _JSON$parse = JSON.parse(localStorage.getItem("formData")), clientSale = _JSON$parse.clientSale, monthSale = _JSON$parse.monthSale, yearSale = _JSON$parse.yearSale;
              if (!(clientSale && monthSale && yearSale)) {
                _context.next = 13;
                break;
              }
              date = "".concat((0,_helpers_formatDate_js__WEBPACK_IMPORTED_MODULE_6__.turningMonthInNumber)(monthSale), "-").concat(yearSale);
              _this$clients$find = this.clients.find(function (client) {
                return client.name === clientSale;
              }), id = _this$clients$find.id;
              apiService = new _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_7__["default"](this.url);
              _context.next = 7;
              return apiService.getMonthSales("os/by-date-id", date, id);
            case 7:
              _yield$apiService$get = _context.sent;
              os = _yield$apiService$get.os;
              if (!(os.length > 0)) {
              ...
              return _context.abrupt("return", objSales);
            case 12:
              objSales = {
      ...
      function searchOs() {
        return _searchOs.apply(this, arguments);
      }
      return searchOs;
    }() // Mostra os items das vendas mensais
  }, {
    key: "ifRightDate",
    value: function ifRightDate(notes) {
      var _this = this;
      var totalSales = 0;
      notes.forEach(function (os) {
        var customMonth = (0,_helpers_formatDate_js__WEBPACK_IMPORTED_MODULE_6__.handleCustomDate)(os.date);
        var totalValue = os.budgetValue > 0 && os.budgetValue !== null ? os.budgetValue : os.total;
        var osTotal = (0,_helpers_monetaryMask__WEBPACK_IMPORTED_MODULE_4__["default"])(totalValue);
      ...
      this.article.innerHTML += "<div class=\"sales__report-total color-13 font-os-xl-b\">\n                          <p>Total:</p>\n                          <p>".concat((0,_helpers_monetaryMask__WEBPACK_IMPORTED_MODULE_4__["default"])(totalSales), "</p>\n                      </div>\n                    ");
    }
    ...
    value: // Renderiza a seção que exibe as vendas do mês e o total vendido
    function () {
      var _renderingMonthSales = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2() {
        var os, salesTitle;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.searchOs();
            case 2:
              os = _context2.sent;
              salesTitle = document.querySelector("[data-sale-title]");
              this.article.innerHTML = "";
              if (!Object.hasOwn(os, "missingMgs")) {
                salesTitle.innerHTML = "Valores vendidos no m\xEAs de ".concat(os.monthName);
                this.btnPrint.style.display = "block";
                this.article.innerHTML += " <h3 class=\"font-os-xl-b color-13\">".concat(os.client, "</h3>");
      ...
      function renderingMonthSales() {
        return _renderingMonthSales.apply(this, arguments);
      }
      return renderingMonthSales;
    ...
    value: function addEvents() {
      var _this2 = this;
      this.form.addEventListener("submit", function (e) {
        return _this2.handleFormSales(e);
      });
      ...
      this.form.querySelectorAll("[data-sale]").forEach(function (field) {
        field.addEventListener("blur", function (e) {
          (0,_client_form_validations__WEBPACK_IMPORTED_MODULE_5__.fieldValidation)(e.target, _this2.errsMsg, _this2.errsType, ".msgError");
        });
      });
    }
  }, {
...
var OsPage = /*#__PURE__*/function () {
  function OsPage(titleCode, osWrapper, btn, url) {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(OsPage, [{
    key: "searchOsById",
    value: // Filtra o array de os's baseado no id fornecido na url
    function () {
      var _searchOsById = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
        var apiServices, _yield$apiServices$ge, os;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return apiServices.getParameters("os/byOs-id", this.urlId);
            case 4:
              _yield$apiServices$ge = _context.sent;
              os = _yield$apiServices$ge.os;
              return _context.abrupt("return", os[0]);
            case 7:
            case "end":
              return _context.stop();
          }
      ...
      function searchOsById() {
        return _searchOsById.apply(this, arguments);
      }
      return searchOsById;
    ...
    key: "filterService",
    value: function () {
      var _filterService = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2() {
        var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              apiServices = new _helpers_api_service_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.url);
              _context2.next = 4;
              return apiServices.getParameters("service_details", String(this.os.id)).then(function (data) {
                return data.data;
              });
            case 4:
              service = _context2.sent;
              filteredService = service.filter(function (item) {
                return item.note_id === _this.os.id;
              });
              return _context2.abrupt("return", filteredService);
            case 9:
              _context2.prev = 9;
              _context2.t0 = _context2["catch"](0);
    ...
    value: function () {
      var _showServiceValues = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee3(serviceContainer) {
        var _this2 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              filteredService = _context3.sent;
              filteredService.forEach(function (element) {
                var serviceValue = _this2.os.budgetValue ? "" : (0,_helpers_monetaryMask_js__WEBPACK_IMPORTED_MODULE_6__["default"])(element.serviceValue);
                var measures = _this2.handleMeasure(element);
    ...
    key: "deleteOs",
    value: function () {
      var _deleteOs = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee5() {
        var _this3 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 13:
              ...
              console.error("Erro ao deletar a os:", _context5.t0);
              _helpers_event_emitter_js__WEBPACK_IMPORTED_MODULE_5__["default"].on("failedMsg", /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee4() {
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee4$(_context4) {
                  while (1) switch (_context4.prev = _context4.next) {
                    case 0:
                      _this3.showDeleteMsg("<p class=\"font-r-l-b\">Houve um problema e a os n\xE3o pode ser deletada, tente novamente mais tarde!</p>", "failedMsg");
                      setTimeout(function () {
                        _this3.removeDeleteMsg();
                      }, 2000);
                    case 2:
                    case "end":
                      return _context4.stop();
    ...
    value: function addEventsOnButton() {
      ...
      this.btn.forEach(function (btn) {
        if (btn.innerText === "EXCLUIR") {
          btn.addEventListener("click", _this4.deleteOs);
          btn.addEventListener("click", _this4.deleteOs);
        } else {
          btn.addEventListener("click", _this4.printServiceOrder);
          btn.addEventListener("click", _this4.printServiceOrder);
        }
      });
    }
    ...
    key: "init",
    value: function () {
      var _init = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee6() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              if (!this.btn.length) {
              ...
              _context6.next = 3;
              return this.searchOsById();
            case 3:
              this.os = _context6.sent;
              this.osCodeOnTitle();
              this.showOsOnScreen();
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(SalesBalance, [{
    ...
    value: function () {
      var _searchOsByDate = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
        var apiService, date, month, year, _yield$apiService$get, os;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              month = (0,_helpers_formatDate_js__WEBPACK_IMPORTED_MODULE_6__.turningMonthInNumber)(date.month);
              year = date.year;
              console.log("Fazendo requisi\xE7\xE3o para: ".concat(this.url, "/os/").concat(month, "/").concat(year));
              _context.next = 8;
              return apiService.getBalance("os/by-month-year", month, year);
            case 8:
              _yield$apiService$get = _context.sent;
              os = _yield$apiService$get.os;
              return _context.abrupt("return", os);
...
searchClient.init();
var showClientsIndex = new _modules_index_show_clients_index_js__WEBPACK_IMPORTED_MODULE_2__["default"]("[data-wrapper]", clients, url);
...
clientPage.init();
var clientOs = new _modules_client_client_os_js__WEBPACK_IMPORTED_MODULE_4__["default"]('[data-os="wrapper"]', "[data-osSearch]", '[data-os="ver-mais"]', '[data-os="ver-menos"]', clientPage.client, url);
clientOs.init();
...
formClient.init();
var formOs = new _modules_client_form_os_js__WEBPACK_IMPORTED_MODULE_6__["default"]("[data-formOs]", "[data-btnServiceAmount]", "[data-serviceItem]", clients, url);
formOs.init();
var osPage = new _modules_osPage_os_page_js__WEBPACK_IMPORTED_MODULE_7__["default"]("[data-titleOs] span", "[data-os]", "[data-buttonOs]", url);
osPage.init();
var monthSales = new _modules_month_sales_month_sales_js__WEBPACK_IMPORTED_MODULE_8__["default"]("[data-form-sales]", "[data-sales-wrapper]", "[data-sale-btn]", clients, url);
monthSales.init();
